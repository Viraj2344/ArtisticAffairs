  ...
  {product
    ...
    .map((item, index) => {
      ...
      return (
        ...
        >
          <div
            className={`border-2 shadow-lg transition-shadow duration-300 rounded-lg ease-in-out border-black-500 border-opacity-60 overflow-hidden ${mode === 'dark' ? 'dark-card' : ''}`}
          >
